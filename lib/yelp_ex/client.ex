defmodule YelpEx.Client do
  ...
  * `:params` See Yelp [docs](https://www.yelp.com/developers/documentation/v3/business_search) for full list of `params`
  * For all other `options` see: [`HTTPoison.request/5`](https://hexdocs.pm/httpoison/0.10.0/HTTPoison.html#request/5)
